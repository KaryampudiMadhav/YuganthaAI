		...
		<section className='relative bg-[var(--bg-color)] text-[var(--text-color)] py-12 md:py-20 px-4 md:px-6 mt-16 overflow-hidden transition-colors duration-300'>
			...
			<div className='max-w-6xl mx-auto text-center relative z-10 space-y-10 animate-fadeInUp'>
				...
				<div className='mb-8 md:mb-10 animate-fadeInDown'>
					<span className='inline-block text-[#A855F7] text-xs md:text-sm font-bold uppercase tracking-wider px-5 py-2.5 bg-[var(--card-bg)] border border-[rgba(139,92,246,0.3)] rounded-full hover:bg-[rgba(139,92,246,0.15)] transition-all duration-300'>
				...
				<div className='grid grid-cols-1 md:grid-cols-3 gap-4 max-w-3xl mx-auto px-4 py-8 md:py-10 animate-fadeInUp animation-delay-200'>
					<div className='bg-[var(--card-bg)] border border-[var(--border-color)] rounded-xl px-4 py-3 hover:bg-[rgba(139,92,246,0.12)] hover:border-[rgba(139,92,246,0.4)] transition-all duration-300 group animate-scaleInUp animation-delay-100'>
					...
					<div className='bg-[var(--card-bg)] border border-[var(--border-color)] rounded-xl px-4 py-3 hover:bg-[rgba(139,92,246,0.12)] hover:border-[rgba(139,92,246,0.4)] transition-all duration-300 group animate-scaleInUp animation-delay-200'>
						<svg className='w-6 h-6 text-[#A855F7] mb-2 mx-auto group-hover:scale-110 transition-transform duration-300' fill='currentColor' viewBox='0 0 20 20'>
					...
					<div className='bg-[var(--card-bg)] border border-[var(--border-color)] rounded-xl px-4 py-3 hover:bg-[rgba(139,92,246,0.12)] hover:border-[rgba(139,92,246,0.4)] transition-all duration-300 group animate-scaleInUp animation-delay-300'>
						<svg className='w-6 h-6 text-[#A855F7] mb-2 mx-auto group-hover:scale-110 transition-transform duration-300' fill='currentColor' viewBox='0 0 20 20'>
