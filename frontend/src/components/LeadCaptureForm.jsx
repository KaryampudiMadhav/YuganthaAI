...
export default function LeadCaptureForm({ courseId, courseName, onClose, onDownload, type = "Brochure" }) {
    ...
    const handleSubmit = async (e) => {
        ...
        try {
            const response = await fetch(`${API_URL}/api/leads`, {
                ...
                body: JSON.stringify({ ...formData, courseId, courseName, type })
            });
            ...
            if (response.ok) {
                ...
                if (type === "Brochure") {
                    toast.success(data.message || "Thank you! Downloading brochure...");
                    if (onDownload) onDownload();
                } else {
                    toast.success("Enrollment request received! We will contact you shortly.");
                }
            ...
            <div className="bg-[#12091F] border border-[rgba(139,92,246,0.3)] rounded-2xl w-full max-w-md p-8 relative shadow-[0_0_50px_rgba(139,92,246,0.2)]">
                ...
                <form onSubmit={handleSubmit} className="space-y-5">
                    ...
                    >
                        ...
                        ) : (type === "Brochure" ? "Download Roadmap" : "Submit Enrollment")}
                    </button>
