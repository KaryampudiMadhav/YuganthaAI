export default function LearningPaths() {
	return (
		<section className='py-12 md:py-20 px-4 md:px-6 bg-gradient-to-r from-gray-400 to-gray-500 text-gray-900 relative overflow-hidden'>
			...
			<div className='max-w-6xl mx-auto relative z-10'>
				<div className='flex flex-col md:flex-row items-center gap-8 md:gap-12'>
					...
					<div className='w-full md:w-1/2'>
						...
						<button className='bg-red-600 hover:bg-red-700 text-white px-6 md:px-8 py-3 md:py-4 rounded-full text-base md:text-lg font-semibold transition duration-200 shadow-lg'>
					...
					{/* Image */}
					<div className='w-full md:w-1/2'>
						<div className='bg-gradient-to-br from-blue-600 to-blue-800 rounded-2xl p-6 md:p-8 shadow-2xl'>
							<div className='text-center text-white'>
								<div className='text-6xl md:text-8xl mb-4 md:mb-6'>📚</div>
								<p className='text-xl md:text-2xl font-semibold'>
									Expert-Curated Learning Paths
								</p>
								<p className='text-base md:text-lg mt-3 md:mt-4 text-blue-200'>
