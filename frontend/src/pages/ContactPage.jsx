...
export default function ContactPage() {
	...
	return (
		<>
			<SEO 
				title="Contact Us - YuganthaAI | Get in Touch"
				description="Contact YuganthaAI for inquiries about our AI courses, mentorship programs, and technology training. Located in Bhimavaram, Andhra Pradesh."
				keywords="contact yuganthaai, get in touch, support, customer service, bhimavaram"
				url="/contact"
			/>
